...
export const TOGGLE_DM_ROUTE = `${AUTH_ROUTES}/toggle-dm`;
...
export const ADD_MEMBERS_TO_CHANNEL = `${CHANNEL_ROUTES}/add-members`;
export const PIN_MESSAGE_ROUTE = `${CHANNEL_ROUTES}/pin-message`;
export const UNPIN_MESSAGE_ROUTE = `${CHANNEL_ROUTES}/unpin-message`;
export const GET_PINNED_MESSAGES_ROUTE = `${CHANNEL_ROUTES}/get-pinned-messages`;
